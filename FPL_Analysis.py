...
def main():
    ...
    format_dict = {'EWM_Pts':'{0:,.1f}','PPG_Season_Total':'{0:,.1f} ppg','mins_ppg':'{0:,.0f}','sum_ppg':'{0:,.1f}','Weighted_ma':'{0:,.1f}','Weighted_mins':'{0:,.0f}','Points_Season_Total':'{0:,.0f}','last_2_years_Games_Total':'{0:,.0f}',
    ...
    additional_info=data_1.loc[:,['full_name','week', 'Games_Total','sum_ppg','mins_ppg','sum_mins','sum_games','ppg_last_10_games','Games_Total_Rolling', 'Gms_Ssn_Total','Games_Ssn_Rmg', 'Gms_Ssn_to_Date','PPG_Total',
    ...
    select_pts=st.sidebar.radio('Select the points you want to optimise',['sum_ppg','Weighted_ma','PPG_Sn_Rllg','PPG_Sn_Rmg','Pts_Sn_Rmg','Pts_Sn_Rllg','Points_Season_Total', 'last_2_years_PPG','PPG_Total'])
    ...
    cols_to_move = ['full_name','Position','Count','team','Price','sum_ppg','mins_ppg','ppg_last_10_games','last_2_years_PPG','last_2_years_MPG','PPG_Sn_Rllg','Gms_Ssn_to_Date','last_2_years_Games_Total','Games_Total',
